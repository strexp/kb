...
-   **IANA Network**
    ...
    Strategic Explorations maintains IANA-accessible infrastructure worldwide as AS207268.

    [Learn More](iana/index.md){ .md-button }

-   **DN42 Network**

    ---

    Strategic Explorations operates in DN42 across different autonomous systems.

    [Learn More](dn42/index.md){ .md-button }
...
| Title                                  | Email                                  |
| :-----------------------------------   | :------------------------------------- |
| NOC of IANA                            | `noc@strexp.net`                       |
| NOC of DN42                            | `dn42@strexp.net`                      |
| Peering Contact                        | `peering@strexp.net`                   |
| Service Administrations                | `admin@strexp.net`                     |
| Information                            | `info@strexp.net`                      |


| Title                                                  | Email                                  |
| :---------------------------------------------------   | :------------------------------------- |
| NOC of Global Network                                  | `noc@nia.dn42`                         |
| Peering Contact of Global Network                      | `peering@nia.dn42`                     |
| NOC of China Network                                   | `noc@gensokyo.dn42`                    |
| Peering Contact of China Network                       | `peering@gensokyo.dn42`                |
